...
const parseEventHelper = (headers, data) => {
    /**
     * @type { {
     *  eventType: string;
    ...
    Object.keys(headers).forEach(key => {
        ...
        if (upperKey.startsWith(CloudEventExtensionHeaderPrefix)) {
            ...
            extensions[extensionName] = headers[key];
            ...
            event[propertyName] = headers[key];
        } else if (upperKey === "CONTENT-TYPE") {
            event["contentType"] = headers[key];
        }
    });
...
module.exports.cloudEventSchema = cloudEventSchema;
module.exports.isCloudEvent = isCloudEvent;
module.exports.explainCloudEvent = explainCloudEvent;
